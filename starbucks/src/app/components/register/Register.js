        ...
        <div>
            ...
            <form>
                <div className="mx-auto bg-white border p-4 shadow-sm rounded-3 mt-3 login-register-form-wrap" style={{width:'550px'}}>
                    <h4 className="text-center text-green-800 fs-20px fw-500 mb-4">Sign Up</h4>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        <label className="mb-1 fs-13px text-green-800">Email</label>
                        <input type="email" placeholder="Password" className="form-control bg-white fs-12px" required style={{height:'40px'}}/>
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-4">
                        <label className="mb-1 fs-13px text-green-800">Confirm password</label>
                        <input type="password" placeholder="Password" className="form-control bg-white fs-12px" required style={{height:'40px'}}/>
                    </div>
                    <div>
